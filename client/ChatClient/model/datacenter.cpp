...
void DataCenter::resetMyself(std::shared_ptr<lbk::GetUserInfoRsp> resp)
{
    if (myself == nullptr) {
        myself = new UserInfo();
    }
    const lbk::UserInfo& userInfo = resp->userInfo();
...
void DataCenter::resetFriendList(std::shared_ptr<lbk::GetFriendListRsp> resp)
{
    ...
    const QList<lbk::UserInfo>& friendListPB = resp->friendList();
...
void DataCenter::resetChatSessionList(std::shared_ptr<lbk::GetChatSessionListRsp> resp)
{
...
void DataCenter::resetApplyList(std::shared_ptr<lbk::GetPendingFriendEventListRsp> resp)
{
...
void DataCenter::resetRecentMessageList(const QString &chatSessionId, std::shared_ptr<lbk::GetRecentMsgRsp> resp)
{
...
void DataCenter::resetMemberList(const QString &chatSessionId, const QList<lbk::UserInfo> &memberList)
{
...
void DataCenter::resetSearchUserResult(const QList<lbk::UserInfo> &userList)
{
...
void DataCenter::resetSearchMessageResult(const QList<lbk::MessageInfo> &msgList)
{
