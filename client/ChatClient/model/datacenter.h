...
public:
    ...
    void getMyselfAsync();
    UserInfo* getMyself();
    void resetMyself(std::shared_ptr<lbk::GetUserInfoRsp> resp);

    // 获取好友列表
    void getFriendListAsync();
    QList<UserInfo>* getFriendList();
    void resetFriendList(std::shared_ptr<lbk::GetFriendListRsp> resp);

    // 获取会话列表
    void getChatSessionListAsync();
    QList<ChatSessionInfo>* getChatSessionList();
    void resetChatSessionList(std::shared_ptr<lbk::GetChatSessionListRsp> resp);

    // 获取好友申请列表
    void getApplyListAsync();
    QList<UserInfo>* getApplyList();
    void resetApplyList(std::shared_ptr<lbk::GetPendingFriendEventListRsp> resp);
    ...
    void resetRecentMessageList(const QString& chatSessionId, std::shared_ptr<lbk::GetRecentMsgRsp> resp);
    ...
    void resetMemberList(const QString& chatSessionId, const QList<lbk::UserInfo>& memberList);

    // 搜索用户
    void searchUserAsync(const QString& searchKey);
    QList<UserInfo>* getSearchUserResult();
    void resetSearchUserResult(const QList<lbk::UserInfo>& userList);
    ...
    void resetSearchMessageResult(const QList<lbk::MessageInfo>& msgList);
