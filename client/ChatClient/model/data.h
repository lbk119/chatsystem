...
public:
    ...
    void load(const lbk::UserInfo& userInfo) {
...
public:
    ...
    void load(const lbk::MessageInfo& messageInfo) {
        ...
        if (type == lbk::MessageTypeGadget::MessageType::STRING) {
            this->messageType = TEXT_TYPE;
            this->content = messageInfo.message().stringMessage().content().toUtf8();
        } else if (type == lbk::MessageTypeGadget::MessageType::IMAGE) {
        ...
        } else if (type == lbk::MessageTypeGadget::MessageType::FILE) {
        ...
        } else if (type == lbk::MessageTypeGadget::MessageType::SPEECH) {
...
public:
    ...
    void load(const lbk::ChatSessionInfo& chatSessionInfo) {
