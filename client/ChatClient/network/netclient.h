...
private:
    ...
    const QString HTTP_URL = "http://192.168.22.129:9000";
    const QString WEBSOCKET_URL = "ws://192.168.22.129:9001/ws";
...
public:
    ...
    // 针对 websocket 的处理
    void handleWsResponse(const lbk::NotifyMessage& notifyMessage);
