...
DEFINE_string(app_id, "118922062", "语音平台应用ID");
DEFINE_string(api_key, "pYlH5l6ZrCJzgk4UJrEk8BoT", "语音平台API密钥");
DEFINE_string(secret_key, "OymLflP0MCGtfTiBecsMRbpKRsDxBujQ", "语音平台加密密钥");
int main(int argc, char *argv[])
{
    google::ParseCommandLineFlags(&argc, &argv, true);
    lbk::init_logger(FLAGS_run_mode, FLAGS_log_file, FLAGS_log_level);

    lbk::SpeechServerBuilder ssb;
