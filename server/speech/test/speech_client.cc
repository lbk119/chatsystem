...
//     // 5. 发起调用
//     lbk::SpeechService_Stub stub(channel.get());
//     lbk::SpeechRecognitionReq req;
//     req.set_speech_content(file_content);
//     req.set_request_id("1111");

//     brpc::Controller *cntl = new brpc::Controller();
//     lbk::SpeechRecognitionRsp* rsp=new lbk::SpeechRecognitionRsp();
