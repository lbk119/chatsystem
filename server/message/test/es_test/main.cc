...
int main(int argc, char *argv[])
{
    ...
    auto es_msg = std::make_shared<lbk::ESMessage>(es_client);
    // es_msg->createIndex();
    // es_msg->appendData("用户ID1", "消息ID1", "会话ID1", 1723025035, "吃饭了吗？");
    // es_msg->appendData("用户ID2", "消息ID2", "会话ID1", 1723025035 - 100, "吃的盖浇饭！");
    // es_msg->appendData("用户ID3", "消息ID3", "会话ID2", 1723025035, "吃饭了吗？");
    // es_msg->appendData("用户ID4", "消息ID4", "会话ID2", 1723025035 - 100, "吃的盖浇饭！");
